window.__ModuleLoader__.load({ id: "@anionex/dsh-vision-cloud", factory: (require) => {
...
function LoadedSettings({ controller, t }) {
    ...
    const selectedProvider = providers.find(entry => entry.provider === draft.provider);
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "dvt-settings", children: [!snapshot.writable ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert warning", children: t('readOnly') }) : null, draftError === undefined ? null : (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert error", children: draftError }), state.error === undefined ? null : (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert error", children: state.error }), state.message === 'saved' ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert success", children: t('saved') }) : null, state.message === 'testOk' ? (0, jsx_runtime_1.jsx)("div", { className: "dvt-alert success", children: t('testOk') }) : null, (0, jsx_runtime_1.jsxs)("section", { className: "dvt-panel dvt-essential", children: [(0, jsx_runtime_1.jsxs)("div", { className: "dvt-panel-title", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { children: t('model') }), (0, jsx_runtime_1.jsx)("p", { children: t('modelHint') })] }), (0, jsx_runtime_1.jsx)("span", { className: `dvt-badge ${snapshot.enabled ? 'ok' : 'error'}`, children: snapshot.enabled ? t('modelName') : t('off') })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dvt-form-grid", children: [(0, jsx_runtime_1.jsx)(Field, { label: t('provider'), children: (0, jsx_runtime_1.jsxs)("select", { "aria-label": t('provider'), disabled: !snapshot.writable || busy, value: draft.provider, onChange: (event) => { update('provider', event.target.value); update('model', ''); }, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: t('off') }), providers.map(entry => (0, jsx_runtime_1.jsx)("option", { value: entry.provider, children: entry.name }, entry.provider))] }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('modelName'), children: (0, jsx_runtime_1.jsxs)("select", { "aria-label": t('modelName'), disabled: !snapshot.writable || busy || draft.provider === '', value: draft.model, onChange: (event) => { update('model', event.target.value); }, children: [(0, jsx_runtime_1.jsx)("option", { value: "", children: t('off') }), models.map(model => (0, jsx_runtime_1.jsx)("option", { value: model.id, children: model.name }, model.id))] }) })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "dvt-save-row", children: [(0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "primary", disabled: !snapshot.writable || busy, onClick: save, children: state.action === 'save' ? t('saving') : t('save') }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", disabled: busy || !snapshot.enabled, onClick: () => { void controller.testRead(); }, children: state.action === 'test' ? t('testing') : t('testRead') }), (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Button, { variant: "outline", disabled: busy, onClick: () => { void controller.load(); }, children: t('reload') })] }), (0, jsx_runtime_1.jsxs)("details", { className: "dvt-advanced", children: [(0, jsx_runtime_1.jsxs)("summary", { children: [(0, jsx_runtime_1.jsxs)("span", { children: [(0, jsx_runtime_1.jsx)("strong", { children: t('advanced') }), (0, jsx_runtime_1.jsx)("small", { children: t('advancedHint') })] }), (0, jsx_runtime_1.jsx)("span", { className: "dvt-details-chevron", "aria-hidden": "true", children: "\u2304" })] }), (0, jsx_runtime_1.jsx)("div", { className: "dvt-advanced-body", children: (0, jsx_runtime_1.jsx)("section", { className: "dvt-panel", children: (0, jsx_runtime_1.jsxs)("div", { className: "dvt-form-grid", children: [(0, jsx_runtime_1.jsx)(Field, { label: t('language'), children: (0, jsx_runtime_1.jsxs)("select", { "aria-label": t('language'), disabled: busy, value: draft.language, onChange: (event) => { update('language', event.target.value); }, children: [(0, jsx_runtime_1.jsx)("option", { value: "zh", children: "\u4E2D\u6587" }), (0, jsx_runtime_1.jsx)("option", { value: "en", children: "English" })] }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('timeout'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { "aria-label": t('timeout'), inputMode: "numeric", disabled: busy, value: draft.timeoutMs, onChange: (event) => { update('timeoutMs', event.target.value); } }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('maxBytes'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { "aria-label": t('maxBytes'), inputMode: "numeric", disabled: busy, value: draft.maxImageBytes, onChange: (event) => { update('maxImageBytes', event.target.value); } }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('maxPixels'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { "aria-label": t('maxPixels'), inputMode: "numeric", disabled: busy, value: draft.maxImagePixels, onChange: (event) => { update('maxImagePixels', event.target.value); } }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('concurrency'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { "aria-label": t('concurrency'), inputMode: "numeric", disabled: busy, value: draft.concurrency, onChange: (event) => { update('concurrency', event.target.value); } }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('maxImages'), children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.Input, { "aria-label": t('maxImages'), inputMode: "numeric", disabled: busy, value: draft.maxImages, onChange: (event) => { update('maxImages', event.target.value); } }) }), (0, jsx_runtime_1.jsx)(Field, { label: t('allowedDirs'), hint: t('allowedDirsHint'), children: (0, jsx_runtime_1.jsx)("textarea", { "aria-label": t('allowedDirs'), rows: 3, disabled: busy, value: draft.allowedDirs, onChange: (event) => { update('allowedDirs', event.target.value); } }) })] }) }) })] }), (0, jsx_runtime_1.jsxs)("footer", { className: "dvt-settings-footer", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("span", { className: "dvt-kicker", children: "DSH plugin" }), (0, jsx_runtime_1.jsx)("h2", { children: t('settingsTitle') }), (0, jsx_runtime_1.jsx)("p", { children: t('settingsIntro') })] }), (0, jsx_runtime_1.jsx)("div", { className: "dvt-release", children: (0, jsx_runtime_1.jsxs)("span", { children: [t('pluginVersion'), " ", (0, jsx_runtime_1.jsx)("strong", { children: snapshot.pluginVersion })] }) })] })] }));
}
const CSS = `
.dvt-settings{display:grid;gap:14px;max-width:900px;padding:8px 2px 32px;color:var(--dsw-alias-label-primary)}
.dvt-settings-footer{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;padding:8px 2px;margin-top:8px;border-top:1px solid var(--dsw-alias-border-l1)}.dvt-settings-footer h2{font-size:18px;letter-spacing:-.015em;margin:3px 0 5px}.dvt-settings-footer p{max-width:620px;margin:0;color:var(--dsw-alias-label-secondary);font-size:11px;line-height:1.5}.dvt-kicker{font-size:10px;text-transform:uppercase;letter-spacing:.1em;color:var(--dsw-alias-state-business-primary);font-weight:700}.dvt-release{display:grid;gap:4px;min-width:170px;padding:9px 11px;border-radius:10px;background:var(--dsw-alias-bg-layer-2);font-size:10px;color:var(--dsw-alias-label-secondary)}.dvt-release span{display:flex;justify-content:space-between;gap:12px;white-space:nowrap}.dvt-release strong{color:var(--dsw-alias-label-primary)}
...
@media(max-width:720px){.dvt-settings-footer{display:grid}.dvt-form-grid{grid-template-columns:1fr}.dvt-panel-title{flex-direction:column}}
`;
function installStyles() {
    const id = '@anionex/dsh-vision-cloud/client';
    const existing = document.querySelector(`style[data-plugin-css="${id}"]`);
    if (existing !== null)
        return () => { };
    const style = document.createElement('style');
    style.dataset.plugin = '@anionex/dsh-vision-cloud';
