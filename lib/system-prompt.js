...
const COMMON_RULES = [
    ...
    'Pass workspace image paths and direct http(s) image URLs in the vision_cloud_tool images argument; pass pasted image attachment ids (e.g. sha256:...) in the attachments argument. Multiple images belonging to one question go in a single call so they can be compared together.',
...
export function visionToolSectionText(capability) {
