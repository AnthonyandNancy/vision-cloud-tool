...
Email `davidyang042@gmail.com` with the subject `dsh-vision-cloud security report`. If GitHub private vulnerability reporting is enabled for the repository, that channel may be used instead.
