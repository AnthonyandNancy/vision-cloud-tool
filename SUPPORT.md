...
Provide the DSH snapshot and profile, plugin commit or release, operating system, Node.js version, the selected vision model, and minimal reproduction steps. For vision defects, attach the smallest non-private input image and the returned structured result.
