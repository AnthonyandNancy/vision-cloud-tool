...
6. Keep exactly the fields from the JSON template; never add extra fields such as identity_analysis, faces, face_analysis, or confidence.
7. ${languageRule}
